...
def test_dependency_graph_ready_agents():
    ...
    agents = [AgentSpec(name='a', prompt='task'), AgentSpec(name='b', prompt='task', depends_on=['a']), AgentSpec(name='c', prompt='task')]
...
def test_topological_order():
    ...
    agents = [AgentSpec(name='c', prompt='task', depends_on=['b']), AgentSpec(name='a', prompt='task'), AgentSpec(name='b', prompt='task', depends_on=['a'])]
    graph = DependencyGraph(agents)
...
def test_iter_layers():
    ...
    agents = [AgentSpec(name='a', prompt='task'), AgentSpec(name='b', prompt='task'), AgentSpec(name='c', prompt='task', depends_on=['a', 'b']), AgentSpec(name='d', prompt='task', depends_on=['c'])]
    graph = DependencyGraph(agents)
...
def test_get_dependents():
    ...
    agents = [AgentSpec(name='a', prompt='task'), AgentSpec(name='b', prompt='task', depends_on=['a']), AgentSpec(name='c', prompt='task', depends_on=['a'])]
    graph = DependencyGraph(agents)
...
def test_get_subtree():
    ...
    agents = [AgentSpec(name='a', prompt='task'), AgentSpec(name='b', prompt='task', depends_on=['a']), AgentSpec(name='c', prompt='task', depends_on=['b'])]
    graph = DependencyGraph(agents)
...
def test_validate_unknown_deps():
    ...
    agents = [AgentSpec(name='a', prompt='task', depends_on=['unknown'])]
    graph = DependencyGraph(agents)
...
def test_get_merge_order():
    ...
    agents = [AgentSpec(name='b', prompt='task', depends_on=['a']), AgentSpec(name='a', prompt='task')]
